<template>
  <div id="cart">
    ...
    <div class="buttons">
    <button :disabled="!cartItems.length" class="button is-info" @click="doCheckOut(user.id)">
...
export default {
  ...
  computed: {
    ...mapGetters(["cartItems", "cartTotal", "cartQuantity","user"]),
  },
  created() {
    this.$store.dispatch("getCartItems");
  },
  methods: {
    ...mapActions(["removeAllCartItems","doCheckOut"]),
